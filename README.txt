...
Этот код для "боя", понятное дело, не годится. Обвязка sql слабая, поддержание коннекта к базе никакое (да его и нет). Все в кучу архитектурно.
Для теста, думаю, может сгодится.
